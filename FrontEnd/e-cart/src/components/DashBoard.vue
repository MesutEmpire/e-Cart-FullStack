    ...
    <div class="flex flex-wrap w-full px-4">
        ...
        <div
          ...
          <div class="p-3 bg-opacity-75 rounded-full bg-gradient-to-br from-indigo-400 to-indigo-600">
            <svg class="w-8 h-8 text-white" viewBox="0 0 28 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                  d="M18.2 9.08889C18.2 11views.5373 16.3196 13.5222 14 13.5222C11.6804 13.5222 9.79999 11.5373 9.79999 9.08889C9.79999 6.64043 11.6804 4.65556 14 4.65556C16.3196 4.65556 18.2 6.64043 18.2 9.08889Z"
                  fill="currentColor" />
              <path
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">{{ store.getNumberOfUsers }}</h4>
      ...
      <div class="w-full px-2 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
        <div
          ...
          <div class="mx-5">
            <h4 class="text-2xl font-semibold text-gray-700">{{productsStore.getNumberOfProducts}}</h4>
